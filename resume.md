...
* **Testing Expertise**: manual testing, automated testing, functional testing, regression testing, sanity testing, exploratory testing, user acceptance testing, test case management, defect management, integration testing, API testing, frontend/backend testing, data validation, acceptance criteria validation, root cause analysis
* **Technical Skills & Languages**: SQL, Python, HTML/CSS, REST API, GraphQL, PostgreSQL, MySQL, Gherkin, JavaScript
* **Tools, Platforms, & Technologies**: Jira, Confluence, Zephyr Scale, Azure DevOps, Postman, Selenium IDE, Selenium Webdriver, AIO Tests, Sentry, Lighthouse, Figma, PyCharm, Visual Studio Code, PyTest, GitHub, Vercel, Heroku, HubSpot, Microsoft Dynamics CRM, Contentful, Stripe, Trevipay, PostGrid, Google Analytics, Google Tag Manager, Microsoft Office Suite, Slack, WebEx, Teams, Zoom
* **Development Methodologies**: Scrum, Kanban, Waterfall, CI/CD, BDD
* **Project Management Skills**: requirements gathering, technical writing, scope management

## Professional Experience

### Software Quality Engineer

**Fusion Worldwide** | Boston, MA (remote) | September 2022 - February 2025
<br>
...
**OE Connection (formerly SmartCo Services, LLC)** | Taunton, MA (remote) | September 2015 - September 2022
<br>
...
**Mercer** | Norwood, MA | September 2014 - September 2015
<br>
*Employee Benefit Management*

* Provided exemplary technical and customer service to plan participants supporting their Defined Benefits (DB) retirement plan(s) via phone and email while protecting their Personally Identifiable Information
* Worked with Tier II Support to investigate and troubleshoot complex issues affecting client-specific software
* Documented and reported software and website issues encountered by plan participants to the product and development teams
